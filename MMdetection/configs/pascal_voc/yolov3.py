...
# runtime settings
runner = dict(type='EpochBasedRunner', max_epochs=8)   # The result from the paper is 4 epoches. However, 4 epoches are unstable because Too small. I change 8 here.
