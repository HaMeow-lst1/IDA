...
def main():
    ...
    weightfile = ida.thermal_model_path
    eval    = FLAGS.eval
    ...
    np.save('thermal_feature.npy', feature_dic)
    print('finish save')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', '-d', type=str, default='data/kaist_thermal.data', help='data definition file')
    ...
    parser.add_argument('--weights', '-w', type=str, default='backupthermal/yolov3_kaist_000050.weights', help='initial weights file')
